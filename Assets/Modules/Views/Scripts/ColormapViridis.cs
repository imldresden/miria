// ------------------------------------------------------------------------------------
// <copyright file="ColormapViridis.cs" company="Technische Universität Dresden">
...
// </author>
// <comment>
//      The Viridis color map was originally created by Stefan van der Walt and Nathaniel J. Smith.
//      Data values taken from https://github.com/BIDS/colormap/blob/master/colormaps.py, licensed under CC0.
// </comment>
// ------------------------------------------------------------------------------------
...
namespace IMLD.MixedRealityAnalysis.Views
{
    ...
    {
        private static readonly Color[] Lut =
        {
        ...
        /// </summary>
        /// <param name="val">A value between 0 and 1.</param>
        ...
        public static Color GetValueAt(float val)
        {
            ...
            int idx = (int)Mathf.Clamp(val * 255, 0, 255);
            return Lut[idx];
        }
    }
}