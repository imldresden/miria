// Custom slider visuals, based on MRTK slidervisuals class.
...
namespace IMLD.MixedRealityAnalysis.Views
{
    ...
    public class SliderVisuals : MonoBehaviour
    {
        ...
        private CustomSlider sliderState;

        /// <summary>
        /// Reference to the <see cref="Slider"/> component.
        /// </summary>
        protected CustomSlider SliderState
        {
            get
            {
                if (sliderState == null)
                {
                    sliderState = GetComponent<CustomSlider>();
                }
