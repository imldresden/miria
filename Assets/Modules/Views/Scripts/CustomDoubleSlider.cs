// Custom double slider, based on MRTK slider class
...
{
    /// <summary>
    /// A slider that can be moved by grabbing / pinching two slider thumbs
    /// </summary>
    ...
    public class CustomDoubleSlider : StatefulInteractable, ISnapInteractable
    {
        ...
        public void SetValue(float newValue, bool sendCallback)
        {
            if (this.value != newValue)
            {
                ...
                if (sendCallback)
                {
                    OnValueUpdated.Invoke(new SliderEventData(oldSliderValue, newValue));
                }
            }
        }
